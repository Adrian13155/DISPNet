...
def main(opt):
    ...
    for epoch in range(opt.epoch_start,num_epoch):
        ...
        for index, data in enumerate(pbar):
            ...
            restored,H,_,_,_,_  = model(inp_ms ,inp_pan)
        ...
        if epoch % 10== 0:
            ...
            with torch.no_grad():
                ...
                for index, datas in enumerate(tqdm(val_dataloader)):
                    ...
                    output,H,_,_,_,_ = model(inp_ms ,inp_pan)
...
def get_opt():
    ...
    parser.add_argument('-batch_size', help='批量大小', default=12, type=int)
    ...
    parser.add_argument('-save_dir', help='日志保存路径', default='/PublicData/xmm/project/DISPNet/experiment', type=str)
