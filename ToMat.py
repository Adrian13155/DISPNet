...
if __name__ == "__main__":
    ...
    weight_path = '/PublicData/xmm/project/DISPNet/experiment/04-29_18:13_LAGConvForWV2ForWV2/epoch=510.pth'
    # validation
    ...
    # full = True
    full = True
    save_root = '/PublicData/cjj/UnifiedPansharpening/DISPNet2024AAAI'
    ...
    with torch.no_grad():
        ...
        for img_name in os.listdir(os.path.join(test_path,'PAN_128')):
            ...
            # 模型推理
            out,H,_,_,_,_ = Generator(ms, pan)
